...
class Item extends MY_Controller {
    ...
    public function UpdateItem()
    {
        ...
        {
            $updateitemQry = "Update Item set party_id='" . $PartyId . "',bill_status=2, `state_code`='" . $StateCode . "', `custom_created_at`='" . date("Y-m-d",strtotime($CreatedAt)) . "',hsn_id='" . $HsnId . "',quantity=" . $Quantity . ",category='" . $Category . "',transport_charge=" . $TransportCharge . ",total_cgst_calculated=" . $CgstCalc . ",total_sgst_calculated=" . $SgstCalc . ",total_igst_calculated=" . $IgstCalc . ",gst_type=" . $GstType . ",amount_with_tax=" . $AmountWithTax . ",dimension='" . $Dimension . "',vahical_no='" . $VehicleNo . "',gp_no='" . $GPNO . "',rest_amount=" . $RestAmount . ",recived_amount=" . $ReceivedAmount . ",mode_of_payment='" . $PaymentMode . "',state_of_supply='" . $StateOfSupply . "',igst=" . $Igst . ",sgst=" . $Sgst . ",cgst=" . $Cgst . ",total_gst=" . $TaxCalculated . ",rate=" . $Rate . ",calculated_amount=" . $CalculatedAmount . ",type='" . $Type . "',product_id='" . $ProductId . "',updated_at=now(),updated_by='" . $this->session->userdata('uuid') . "' where uuid='".$Itemid."';";//exit;
