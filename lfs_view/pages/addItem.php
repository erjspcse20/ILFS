...
<script>
    ...
    $("#ReceivedAmount").keyup(function () {
        ...
        $("#RestAmount").val(calamtrest.toFixed(2));
        $("#RestAmountShow").val(calamtrest.toFixed(2));
    });
    $("#Quantity").keyup(function () {
        let qty=parseFloat($("#Quantity").val());
        let rate=parseFloat($("#Rate").val());
        let calamt=isNaN(rate*qty)?0:(rate*qty);
        $("#CalculatedAmount").val(calamt.toFixed(2));
        $("#Calculated").val(calamt.toFixed(2));
        ...
        $("#AmountWithTax").val(amountwithtax.toFixed(2));
        $("#AmountWithTaxShow").val(amountwithtax.toFixed(2));
        $("#TaxCalculated").val(gstcal.toFixed(2));
        $("#TaxCalculatedShow").val(gstcal.toFixed(2));
    });
    $("#Rate").keyup(function () {
        let qty=parseFloat($("#Quantity").val());
        let rate=parseFloat($("#Rate").val());
