                ...
                <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered table-hover table-responsive t">
                        ...
                        for($i=0;$i<count($ProductData);$i++) {
                            ...
                            <tr>
                                <td><?=($i+1);?></td>
                                <td><a href="<?=base_url('welcome-to-ilfs-edit-product.jsp/'.$ProductData[$i]["uuid"])?>" style="font-size:20px;" name="ed"><i class="fa fa-pencil-square-o fa-fw"></i></i></a></td>
                                <td><?=$ProductData[$i]["name"];?></td>
                                <td><?=$ProductData[$i]["hsncode"];?></td>
                            </tr>
                            <?php
                        }
                        ?>
