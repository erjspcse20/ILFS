...
<div class="right_col" role="main">
    <div class="row">
        ...
        <div class="col-md-12 col-xs-12">
            ...
            <form action="<?=base_url('welcome-to-ilfs-gentate-bill.jsp')?>" method="post" id="billform">
                <input type="hidden" name="party" id="party" value="<?=$PartyId?>"/>
                <div class="x_title">
    ...
    <script>
        ...
        $("#genratebill").click(function () {
            if ($("#billform input:checkbox:checked").length <= 0)
            {
